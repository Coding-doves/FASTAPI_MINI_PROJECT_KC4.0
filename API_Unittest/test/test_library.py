...
from app.Router.library import BookCollection
...
class TestBookCollectionAPI(unittest.TestCase):
    ...
    def test_add_new_book(self):
        ...
        response = self.client.post("/lib/books/", json={
            "id": "1",
            "title": "Book Title",
            "author": "Author Name",
    ...
    def test_retrieve_all_books(self):
        ...
        self.client.post("/lib/books/", json={
            "id": "1",
            "title": "Book Title",
            "author": "Author Name",
            "publication": "Publisher",
        ...
        response = self.client.get("/lib/all_books/")
        self.assertEqual(response.status_code, 200)
    ...
    def test_retrieve_a_book(self):
        ...
        response = self.client.get("/lib/one_book/1")
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json(), {
            "id": "1",
            "title": "Book Title",
    ...
    def test_update_a_book(self):
        ...
        response = self.client.put("/lib/edit_book/1", json={
            "id": "1",
            "title": "Updated Title",
    ...
    def test_delete_a_book(self):
        ...
        response = self.client.delete("/lib/del_book/1")
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.json(), {
            "id": "1",
            "title": "Book Title",
    ...
    def test_retrieve_a_book_not_found(self):
        ...
        response = self.client.get("/lib/one_book/999")
        self.assertEqual(response.status_code, 404)

    def test_update_a_book_not_found(self):
        """Test updating a book that does not exist."""
        response = self.client.put("/lib/edit_book/999", json={
            "id": "999",
    ...
    def test_delete_a_book_not_found(self):
        ...
        response = self.client.delete("/lib/del_book/999")
        self.assertEqual(response.status_code, 404)
